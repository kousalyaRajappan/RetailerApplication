...
public class HomeAdapterMainBill extends RecyclerView.Adapter<HomeAdapterMainBill.ViewHolder> {

    private final ArrayList<Item> mValues;
    private final Context mContext;
    protected ItemListener mListener;

    public HomeAdapterMainBill(Context context, ArrayList<Item> values, ItemListener itemListener) {
        mValues = values;
        mContext = context;
...
//                relativeLayout.setLayoutParams(layoutParams);
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.row_item_main_bill, parent, false);
