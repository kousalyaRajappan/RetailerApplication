...
public class Command {
	...
	byte[] command = new byte[]{DLE, EOT, 4}; // Correct command to request paper status
	 ...
	 */
	//实时状态传送指令
//	public static byte[] DLE_eot = new byte[] {0x10, 0x04, 0x01 };
//	public static byte[] DLE_eot = new byte[] {DLE, 0x04, 0x00 };

	public static final byte ESC = 0x1B; // ESC command
	public static final byte DLE = 0x10; // DLE command
	public static final byte EOT = 0x04; // EOT command
